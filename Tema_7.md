...
```
### Результат
![Mеню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_1.png)

## Выводы

Создан текстовый документ.
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_2.png)

## Выводы

В данном коде:
1. f = open('input.txt', 'r') - открывает файл 'input.txt' в режиме чтения и создает файловый объект.
2. print(f.readline()) - считывает первую строку из файла и выводит ее на экран.
3. f.close() - закрывает файл, освобождая системные ресурсы
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_3.png)
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_4.png)
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_5.png)

## Выводы

В данном коде:
1. with open('input.txt') as f: - открывает файл 'input.txt' в режиме чтения по умолчанию, используя менеджер контекста.
2. for line in f: - итерируется по файловому объекту, последовательно считывая каждую строку.
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_6.png)
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_7_2.png)
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_8.png)

## Выводы

В данном коде:
1. import os - импортирует модуль для работы с операционной системой.
...
5. print(f'Папка {catalog[0]} содержит:') - выводит путь к текущей папке.
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_9.png)

## Выводы

В данном коде:
1. with open(file, encoding='utf-8') as f: - открывает файл с указанием кодировки UTF-8.
2. words = f.read().split() - читает весь файл и разбивает на слова по пробелам.
3. max_length = len(max(words, key=len)) - находит длину самого длинного слова.
4. or word in words: - перебирает все слова для поиска самых длинных.
...
```
### Результат
![Меню](https://github.com/EmirHan5534/Software_Engineering/blob/%D0%A2%D0%B5%D0%BC%D0%B0_7/pic/Lab7_10.png)

## Выводы

В данном коде:
1. import csv, datetime, time - импортирует необходимые модули для работы с CSV, временем и задержками.
